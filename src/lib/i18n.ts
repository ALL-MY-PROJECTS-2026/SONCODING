...
const dictionaries = {
  ko: {
    ...
    home: {
      ...
      heroTitle: "실무를 가르치고,\n제품을 만듭니다",
      heroDesc:
        "포켓코딩은 10년 강의 경력의 IT 교육과, 필요한 것을 직접 만드는 소프트웨어 개발을 함께합니다. 배우는 곳이자, 만드는 곳입니다.",
      heroPrimary: "무료 상담 신청",
      heroSecondary: "서비스 둘러보기",
      statsTitle: "숫자로 보는 포켓코딩",
      stats: [
    ...
    about: {
      ...
      lead: "포켓코딩은 IT 교육과 소프트웨어 개발을 함께하는 팀입니다. 우리는 배움과 실전이 분리되어서는 안 된다고 믿습니다.",
      missionTitle: "우리의 미션",
      missionDesc:
  ...
  en: {
    ...
    home: {
      ...
      heroDesc:
        "POCKET_CODING pairs practical IT education with dependable software development. A place to learn — and a place to build.",
      heroPrimary: "Book a free consult",
      heroSecondary: "Explore services",
      statsTitle: "POCKET_CODING in numbers",
      stats: [
    ...
    about: {
      ...
      lead: "POCKET_CODING is a team that does both IT education and software development. We believe learning and real work should never be separate.",
